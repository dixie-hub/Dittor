...
/* # for 0.5.0.0-alpha-dev Approximate date when this software was released.
   (Updated when the version changes.) */
#define APPROX_RELEASE_DATE "2026-02-12"

/* tor's build directory */
#define BUILDDIR "/mnt/e/uni/5 ano/2 sem/Tese/Dittor/tor"
...
/* Compiler version */
#define COMPILER_VERSION "15.2.0"

/* tor's configuration directory */
#define CONFDIR "/usr/local/etc/tor"

/* Flags passed to configure */
#define CONFIG_FLAGS "--disable-asciidoc --disable-manpage --disable-html-manual --disable-unittests --no-create --no-recursion"
...
#define PACKAGE_STRING "tor 0.5.0.0-alpha-dev"
...
#define PACKAGE_VERSION "0.5.0.0-alpha-dev"
...
#define SRCDIR "/mnt/e/uni/5 ano/2 sem/Tese/Dittor/tor"
...
#define VERSION "0.5.0.0-alpha-dev"
